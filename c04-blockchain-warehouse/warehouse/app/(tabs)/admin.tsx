  ...
  if (user && user.role !== "ADMIN") {
    return (
      <View style={styles.centered}>
        ...
        <Text style={styles.lockedSub}>You don't have permission to view this screen</Text>
      </View>
    );
  }
...
const styles = StyleSheet.create({
  ...
  lockedTitle: { fontSize: 18, fontWeight: "bold", color: COLORS.textSecondary, marginTop: 16 },
  lockedSub:   { fontSize: 13, color: COLORS.textFaint, textAlign: "center", marginTop: 8 },
  scroll:   { flex: 1 },
  content:  { padding: 16 },
