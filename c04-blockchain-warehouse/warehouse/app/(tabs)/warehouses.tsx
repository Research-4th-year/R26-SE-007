  ...
  return (
    <View style={styles.screen}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>{warehouses.length} active warehouses</Text>
      </View>
            ...
            <View key={wh.id} style={styles.card}>
              ...
              <View style={styles.statsRow}>
                ...
                <View style={styles.statItem}>
                  ...
                  <Text style={[styles.statValue, { color: COLORS.info }]}>{wh.availableTons} t</Text>
                </View>
                <View style={styles.statItem}>
                ...
                {wh.reliabilityScore !== null && (
                  <View style={styles.statItem}>
                    ...
                    <View style={styles.gnnRow}>
                      <Ionicons
                        name={wh.reliabilityScore > 0.7 ? "shield-checkmark" : "warning"}
                        size={12}
                        color={getReliabilityColor(wh.reliabilityScore)}
                      />
                      <Text style={[styles.gnnValue, { color: getReliabilityColor(wh.reliabilityScore) }]}>
...
const styles = StyleSheet.create({
  ...
  warehouseName: { color: COLORS.textPrimary, fontWeight: "bold", fontSize: 16 },
  ...
  progressTrack: { backgroundColor: COLORS.borderLight, borderRadius: 999, height: 8, marginBottom: 12 },
