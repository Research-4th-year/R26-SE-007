...
function generatedByMeta(
  ...
  if (s === "llm") {
    return {
      label: t.predictionExplanation.generatedByAI,
  ...
  if (s === "shap") {
    return {
      label: t.predictionExplanation.generatedBySHAP,
      icon: "cog" as const,
    };
  }

  return {
    label: `${t.predictionExplanation.generatedBy} ${source}`,
...
export default function PredictionExplanationScreen() {
  ...
  const generatedBy = generatedByMeta(explanation.generated_by, t);
      ...
      <SafeAreaView style={styles.safe}>
        ...
        <View style={styles.hero}>
          ...
          <View style={styles.eyebrowPill}>
            ...
            <Text style={styles.eyebrow}>{t.predictionExplanation.eyebrow}</Text>
          </View>

          <Text style={styles.heroTitle}>{t.predictionExplanation.title}</Text>
          ...
          >
            ...
            {explanation.key_factors.length > 0 && (
              <View style={styles.factorsSection}>
                <Text style={styles.sectionTitle}>{t.predictionExplanation.keyFactors}</Text>
