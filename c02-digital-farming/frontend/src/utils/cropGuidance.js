// Utility for generating dynamic Paddy Crop Guidance

export const generateCropTimeline = (variety, ageGroup, zone, irrigation, cultivationDate) => {
  // Parse duration
  ...
  // Fertilizer logic (DoA rules abstracted)
  // Irrigated Dry/Intermediate usually needs more fertilizer.
  // Rainfed/Wet requires slightly less due to leaching or lower yield potential.
  ...
  stages.push({
    id: 1,
    title: "DAY 0 — Land Preparation & Establishment (භූමි සකස් කිරීම)",
    date: cultivationDate || "Day 0",
    icon: "🌱",
    activities: [
